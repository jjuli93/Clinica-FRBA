...
(
usu_idUser int IDENTITY(1,1) ,
usu_idEstadoCivil tinyint FOREIGN KEY REFERENCES EstadoCivil(estC_idEstadoCivil),
usu_idTipoDocumento tinyint FOREIGN KEY REFERENCES TipoDocumento(tipoD_idTipoDocumento),
...
(
tipoEs_idTipoEspecialidad int IDENTITY(1,1) PRIMARY KEY,
tipoEs_codigo numeric(18,0),  
tipoEs_detalle varchar(255)
);

CREATE TABLE Especialidad
(
espe_idEspecialidad int IDENTITY(1,1),
espe_idTipoEspecialidad int NOT NULL FOREIGN KEY REFERENCES TipoEspecialidad(tipoEs_idTipoEspecialidad),  
espe_codigo int,
